...
App que muestra ua lista con el clima de una lista de ciudades
Al seleccionar la ciudad muestra el clima para los próximos 7 días

Creado con REACT,  REDUX Y OPENWEATHERMAP API
...
Navegar a localhost:3000 en el navegador web para empezar a usarla
